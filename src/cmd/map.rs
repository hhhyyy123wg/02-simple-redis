use crate::{backend::Backend, cmd::Get, RespArray, RespFrame, RespNull};

use super::{extract_args, validate_command, CommandError, CommandExecutor, Set, RESP_OK};
...
#[cfg(test)]
mod tests {
    use crate::{cmd::RESP_OK, RespDecode};
    ...
    fn test_set_from_resp_array() -> Result<()> {
        ...
        assert_eq!("hello", result.key);
        assert_eq!(RespFrame::BulkString(b"world".into()), result.value);
        Ok(())
    }
